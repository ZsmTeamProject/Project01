...
# 读取数据集
data = pd.read_csv("../data/Version_ywc_0.0.1.csv")
...
model = Sequential()
model.add(Dense(1024, input_dim=656, activation='relu'))
...
history = model.fit(X_train, y_train, epochs=60, batch_size=batch_size, validation_split=0.2)
